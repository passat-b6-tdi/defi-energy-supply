...
/**
 * @title Energy Producer Token contract (ERC721 standard)
 * @author Bohdan
 */
contract EnergyProducerToken is ERC721TokenBase {
    ...
    constructor() ERC721TokenBase("Energy Producer Token", "NRGPT", "") {}
}
